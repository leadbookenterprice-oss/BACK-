...
from .views import (
    ...
    OnboardingView, video_status, publicar_instagram, send_otp, verify_otp, request_trial_token, whatsapp_message_status, validate_access_code,
...
urlpatterns = [
    ...
    path('auth/whatsapp-message-status/<str:sid>/', whatsapp_message_status, name='auth_whatsapp_message_status'),
