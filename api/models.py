...
class APIKey(models.Model):
    ...
    models_last_synced_at = models.DateTimeField(null=True, blank=True)
    models_last_error    = models.TextField(null=True, blank=True)
    ...
    cloudinary_usage_percent = models.FloatField(null=True, blank=True)
    cloudinary_status = models.CharField(max_length=30, blank=True, null=True)
    cloudinary_error = models.TextField(null=True, blank=True)
    cloudinary_upload_probe_ok = models.BooleanField(null=True, blank=True)
    cloudinary_last_tested_at = models.DateTimeField(null=True, blank=True)
